...
const StarRating = (props) => {
    ...
    const onSubmit= () =>  {
        ...
        axios.post("http://localhost:5000/rating/saveRating", variables)
            .then((response) => {
        ...
        <div>
            {isAuthenticated === true ? (
                <div>
                    ...
                    <h4 className="font-weight-bold">Average Rate {calculateAvgRate()}</h4>
            ...
            {rating > 0 ? <p className="text-success">We value your feedback. Thank you!</p> : ""}
